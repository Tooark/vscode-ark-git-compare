...
[![Marketplace Installs](https://img.shields.io/visual-studio-marketplace/i/tooark.git-compare?label=instala%C3%A7%C3%B5es)](https://marketplace.visualstudio.com/items?itemName=tooark.git-compare)
